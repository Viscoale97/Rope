...
public class Rope : MonoBehaviour
{
    ...
    public void Spawn()
    {
        ...
        for (int x = 0; x < count; x++)
        {
            ...
            tmp = Instantiate(partPrefab, new Vector3(transform.position.x, transform.position.y * partDistance, transform.position.z), Quaternion.identity, parentObject.transform);
